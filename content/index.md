...
Moi c'est Damien, et vous vous trouvez sur mon magnifique site Internet fait avec [Quartz](https://quartz.jzhao.xyz/) !
...
<script>
  ...
  function majCompteur() {
    const ecoulees = Math.floor(Date.now() / 1000) - depart;
    document.getElementById("compteur").textContent = ecoulees.toLocaleString("fr-FR");
  }
  majCompteur();
