...
// @ts-ignore
import dappledLightScript from "../../components/scripts/dappledLight.inline"
...
('script')[0];
  ...
  // dappled-light WebGL animation for the index page
  componentResources.afterDOMLoaded.push(dappledLightScript)
